          ...
          <ContentWrapper>
            ...
            <Divider>
              <InputRow>
                <InputGroup>
                  <Label>이름</Label>
                  <Input type="text" value={'김옥순'} readOnly />
                </InputGroup>
                <InputGroup>
                  <Label>나이</Label>
              ...
              <InputGroup>
                ...
                <Input type="text" value={'010-1111-1111'} readOnly />
              </InputGroup>
              <InputGroup>
                <Label>주소</Label>
              ...
              <InputRow>
                <InputGroup>
                  <Label>키</Label>
                  <Input type="text" value={'160 cm'} readOnly />
                </InputGroup>
                <InputGroup>
                  <Label>몸무게</Label>
                  <Input type="text" value={'42 kg'} readOnly />
                </InputGroup>
              </InputRow>
            </Divider>
          </ContentWrapper>
